...
class csvWriter(object):
    ...
    def __init__(self, filename, search=False, repost=False, temp=False, breakpos=False):
        ...
        self.temp = temp
        if self.search:
            self.header = ['keyword', 'user_id', 'screen_name',
                           'bw_id', 'repost_count', 'topic', 'content', 'created_at']
        if self.repost:
            self.header = ['center_bw_id', 'user_id', 'screen_name', 'bw_id', 'origin', 'repost_count', 'fs_count',
